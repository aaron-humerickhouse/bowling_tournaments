...
ActiveRecord::Schema.define(version: 20_210_914_032_509) do
  ...
  create_table 'addresses', force: :cascade do |t|
    ...
    t.float 'latitude'
    t.float 'longitude'
    t.index %w[street_address secondary_address city state zip_code], name: 'index_on_full_address',
                                                                      unique: true
  end
  ...
  create_table 'alleys', force: :cascade do |t|
    ...
    t.index %w[name address_id], name: 'index_alleys_on_name_and_address_id', unique: true
  end
  ...
  create_table 'tournaments', force: :cascade do |t|
    ...
    t.index %w[name alley_id starts_at], name: 'index_tournaments_on_name_and_alley_id_and_starts_at'
